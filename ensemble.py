...
while n <= 300:
    ...
    model, epoch, time_spent = nfode.train(model, device, t_data, x_data, threshold=0.008, k=n, lr=0.01, milestones=[120], gamma=0.1)
...
np.save('/home/liyilin/nfode/uq/params_matrix.npy', params_matrix)
np.save('/home/liyilin/nfode/uq/error_matrix.npy', error_matrix)
np.save('/home/liyilin/nfode/uq/epochs_vector.npy', epochs_vector)
np.save('/home/liyilin/nfode/uq/time_spent_vector.npy', time_spent_vector)